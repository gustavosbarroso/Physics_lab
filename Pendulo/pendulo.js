class SimplePendulum {
    ...
    solve() {
        ...
        for (
            ...
            this.x.push(
                L * Math.sin(this.theta[k])
            );

            this.y.push(
                -L * Math.cos(this.theta[k])
            );
        }
    ...
    drawPendulum(ctx) {
        ...
        const visualLength = 300;

        const scale =
            visualLength / Math.max(L, 0.1);
        ...
        const bobX =
            this.pivotX
            +
            this.x[this.frame] * scale;


        const bobY =
            this.pivotY
            +
            this.y[this.frame] * scale;
