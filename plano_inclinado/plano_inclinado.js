class InclinedPlaneSolids {
    ...
    constructor(canvas, options = {}) {
        ...
        // Intervalo temporal mostrado no gráfico
        this.graphTimeMax = 1;
    ...
    solve() {
        ...
        // -----------------------------------------------------
        // O tempo total depende diretamente de L.
        // -----------------------------------------------------
        ...
        // ESCALA DO GRÁFICO
        //
        // O intervalo temporal é condicionado ao comprimento L.
        //
        // O gráfico mostra exatamente o intervalo necessário
        // para o sólido mais lento percorrer L.
        // =====================================================
        ...
        // Garante que o gráfico nunca fique menor
        // que o tempo mínimo da simulação.
        this.graphTimeMax =
            Math.max(
                this.graphTimeMax,
                this.dt
    ...
    // GRÁFICO
    //
    // O intervalo temporal é determinado por L.
    // =========================================================
    ...
    iniciar() {
        ...
        const loop = () => {
            ...
            // =================================================
            // TERMINA QUANDO O ÚLTIMO SÓLIDO CHEGA AO FINAL
            // =================================================
